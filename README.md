...
7. You can then browse to the app on https://localhost:3000 and log in with either of the test users:

    email: bob@test.com or tom@test.com or jane@test.com
    
    password: Pa$$w0rd
	
NOTE: If you are unable to log in with any of these account you need to run the following query in the db UPDATE AspNetUsers SET EmailConfirmed = 1;
